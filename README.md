...
for t = 1:n
 ...
 SOC_history(t) = SOC;
 grid_power(t) = grid_demand(t) + power_flow(t); 
end
%% Normalized SOC
...
## Output
<img width="725" height="636" alt="image" src="https://github.com/user-attachments/assets/3622983e-5563-4ce8-bae6-019233e58d7a" />
